...
ids = ["%23noidea",
       "%23noclue",] # enter your search terms
...
def get_data(kid, max_id=None):
    try:
        d = t.search(q=kid, count = '100', result_type = 'recent', lang = 'en', max_id = max_id) # lang = 'en'
...
class Scrape:
    def __init__(self):    
        engine = sqlalchemy.create_engine("sqlite:///test2.sqlite", echo=False)  
